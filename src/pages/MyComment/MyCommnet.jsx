        ...
        <div className={cx('container_my-comment')}>
            ...
            <div className={cx('wrapper_my-comment')}>
                <div className={cx('wrapper-type')}>
                    ...
                    <span className={cx('type-title')}>Nhận xét của tôi</span>
                </div>
                <Row>
                    <Col xs={0} sm={5}>
                    ...
                    <Col className={cx('col')} xs={0} sm={19} style={{ padding: '0 16px' }}>
                        <div className={cx('information')}>Nhận xét của tôi </div>
                        <div className={cx('wrapper_right')}>
                            <div className={cx('element')}>
                                ...
                                <p>
                                    <span>
                                        Viết nhận xét với sản phẩm bạn đã sử dụng để cung cấp thông tin hữu ích cho mọi
                                        người
                                    </span>
                                </p>
