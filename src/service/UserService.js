...
export const findPhoneForUser = async (phone) => {
  try {
    const response = await axios.get(`${process.env.REACT_APP_API_URL}/user/find-phone`, {
      params: {
        phone: phone,
      },
    });
    ...
    console.error('Error finding phone user:', error);
    throw error;
  }
};
