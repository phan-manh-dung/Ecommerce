    ...
    <div className={cx('container_user')}>
      <div className={cx('wrapper_user')}>
        ...
        >
          ...
          >
            {/* id */}
            <Form.Item label="Id Order" name="id" rules={[{ required: true, message: 'Please input your id!' }]}>
            ...
            >
              <Input value={setStateOrderDetails.country} onChange={handleOnChangeDetail} name="country" />
            </Form.Item>
            {/*city */}
            ...
            >
              <Input value={setStateOrderDetails.district} onChange={handleOnChangeDetail} name="district" />
            </Form.Item>
            {/* phone */}
            ...
            >
              <Input value={setStateOrderDetails.shippingPrice} onChange={handleOnChangeDetail} name="shippingPrice" />
            </Form.Item>
            {/* total price */}
            <Form.Item
              label="Total Price"
            ...
            >
              <Input value={setStateOrderDetails.totalPrice} onChange={handleOnChangeDetail} name="totalPrice" />
            </Form.Item>
            {/* payment method */}
            <Form.Item
            ...
            >
              <Input value={setStateOrderDetails.paymentMethod} onChange={handleOnChangeDetail} name="paymentMethod" />
            </Form.Item>
            {/* paid */}
            <Form.Item label="Paid" name="isPaid" rules={[{ required: true, message: 'Please input your isPaid!' }]}>
            ...
            >
              <Input value={setStateOrderDetails.isDelivered} onChange={handleOnChangeDetail} name="isDelivered" />
            </Form.Item>
            {/* create at */}
            <Form.Item
              label="Create At"
            ...
            >
              <Input value={setStateOrderDetails.createdAt} onChange={handleOnChangeDetail} name="createdAt" />
            </Form.Item>
            {/* update at */}
            <Form.Item
              label="Update At"
            ...
            >
              <Input value={setStateOrderDetails.updatedAt} onChange={handleOnChangeDetail} name="updatedAt" />
            </Form.Item>
