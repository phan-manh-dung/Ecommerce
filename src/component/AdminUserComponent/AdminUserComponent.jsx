        ...
        >
          <Loading isLoading={isLoading || isLoadingUpdated}>
            ...
            >
              ...
              <Form.Item label="Admin" name="isAdmin" rules={[{ required: true, message: 'Please input your Admin!' }]}>
                <Input value={stateUserDetails.isAdmin} onChange={handleOnChangeDetail} name="isAdmin" />
              </Form.Item>
              ...
              <Form.Item label="Sex" name="sex" rules={[{ required: true, message: 'Please input your Sex!' }]}>
              ...
              >
                <Input value={stateUserDetails.country} onChange={handleOnChangeDetail} name="country" />
              </Form.Item>
