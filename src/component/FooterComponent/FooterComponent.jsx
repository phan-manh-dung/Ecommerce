...
const arrImageWeb = {
  ...
  fb: 'https://res.cloudinary.com/ds3jorj8m/image/upload/v1722426743/rj5yvjwmmu7zx8ue7x7r.png',
    ...
    <div className={cx('wrapper_footer')}>
      <div className={cx('container_footer')}>
        ...
        <div className={cx('information')}>
          ...
          <p>
            Shop MD nhận đặt hàng trực tuyến và giao hàng tận nơi, chưa hỗ trợ mua và nhận hàng trực tiếp tại văn phòng
