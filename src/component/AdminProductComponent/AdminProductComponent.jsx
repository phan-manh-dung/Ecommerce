        ...
        <Loading isLoading={isLoading}>
          ...
          >
            ...
            >
                ...
                rules={[
                  { required: true, message: 'Please input your name!' },
                  {
                    validator: (_, value) => {
                      ...
                      if (wordCount < 8) {
                        return Promise.reject(new Error('Name must contain at least 10 words.'));
                      }
              ...
              >
                <Input value={stateProduct.name} onChange={(e) => handleOnChange(e.target.value, 'name')} name="name" />
              </Form.Item>
              {/* Description */}
              <Form.Item
                label="Description"
              ...
              {/* color */}
              <Form.Item label="Color" name="color" rules={[{ required: true, message: 'Please input your color!' }]}>
                <Select
                  name="color"
                  ...
                  { required: true, message: 'Please input your Price!' },
                  {
                    validator: (_, value) => {
                      ...
                      if (value && /[^0-9]/.test(value)) {
                        return Promise.reject(new Error('Price must be a number without special characters.'));
                      }
                      if (!value || value.length > 10) {
                        return Promise.reject(new Error('Price must be a number with a maximum of 10 digits.'));
                      }
                      if (Number(value) <= 0) {
                ...
                rules={[
                  { required: true, message: 'Please input your countInStock!' },
                  {
                    validator: (_, value) => {
                      // Kiểm tra ký tự đặc biệt
                      if (value && /[^0-9]/.test(value)) {
                        return Promise.reject(new Error('Stock must be a number without special characters.'));
                      }
                      if (!value || value.length > 5) {
                        return Promise.reject(new Error('Stock must be a number with a maximum of 10000 digits.'));
                      }
                      if (Number(value) <= 0) {
                ...
                rules={[
                  { required: false, message: 'Please input your Discount!' },
                  {
                    validator: (_, value) => {
                      ...
                      // Kiểm tra ký tự đặc biệt
                      if (value && /[^0-9]/.test(value)) {
                        return Promise.reject(new Error('Discount must be a number without special characters.'));
                      }
                      if (!value || value.length > 2) {
                        return Promise.reject(new Error('Discount must be a number with a maximum of 100 digits.'));
                      }
                      if (Number(value) <= 0) {
        ...
        >
          <Loading isLoading={isLoading || isLoadingUpdated}>
            ...
            >
              ...
              >
                <Input value={stateProductDetails.countInStock} onChange={handleOnChangeDetail} name="countInStock" />
              </Form.Item>
              ...
              >
                <Input value={stateProductDetails.rating} onChange={handleOnChangeDetail} name="rating" />
              </Form.Item>
              <Form.Item
                label="Description"
                name="description"
              ...
              >
                <Input value={stateProductDetails.description} onChange={handleOnChangeDetail} name="description" />
              </Form.Item>
              <Form.Item label="Color" name="color" rules={[{ required: true, message: 'Please input your Color!' }]}>
              ...
              >
                <Input value={stateProductDetails.discount} onChange={handleOnChangeDetail} name="discount" />
              </Form.Item>
              {/* image */}
              <Form.Item label="Image" name="image" rules={[{ required: true, message: 'Please input your Image!' }]}>
                <div>
